...
let key11 = clickOutput0 + soumu[11].name;
...
let key11_1 = clickOutput1 + soumu[11].name;
...
let key11_2 = clickOutput2 + soumu[11].name;
...
let KEY11 = '退' + clickOutput0 + soumu[11].name;
...
let KEY11_1 = '退' + clickOutput1 + soumu[11].name;
...
let KEY11_2 = '退' + clickOutput2 + soumu[11].name;
...
let result11 = '<p>' + localStorage.getItem(key11) + '</p>';
if(localStorage.getItem(key11) !== null){
    his.insertAdjacentHTML('beforeend',result11);
}
...
let result11_1 = '<p>' + localStorage.getItem(key11_1) + '</p>';
if(localStorage.getItem(key11_1) !== null){
    his.insertAdjacentHTML('beforeend',result11_1);
}
...
let result11_2 = '<p>' + localStorage.getItem(key11_2) + '</p>';
if(localStorage.getItem(key11_2) !== null){
    his.insertAdjacentHTML('beforeend',result11_2);
}
